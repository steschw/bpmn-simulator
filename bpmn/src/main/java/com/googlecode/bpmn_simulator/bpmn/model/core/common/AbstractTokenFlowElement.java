...
import com.googlecode.bpmn_simulator.bpmn.trigger.InstantiableNotifiyTarget;
...
public abstract class AbstractTokenFlowElement
	...
	private final Tokens innerTokens = new Tokens();
...
//		assert getInnerTokens().contains(token);
	...
	protected boolean hasToken() {
		final Tokens token = getInnerTokens();
