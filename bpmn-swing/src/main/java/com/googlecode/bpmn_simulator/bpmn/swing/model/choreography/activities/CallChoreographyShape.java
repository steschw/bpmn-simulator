...
public final class CallChoreographyShape
		extends AbstractChoreographyActivityShape<CallChoreography> {

	public CallChoreographyShape(final CallChoreography element) {
		super(element);
	}
