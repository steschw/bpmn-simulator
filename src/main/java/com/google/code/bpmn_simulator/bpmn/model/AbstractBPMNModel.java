...
import com.google.code.bpmn_simulator.bpmn.model.collaboration.MessageFlow;
import com.google.code.bpmn_simulator.bpmn.model.collaboration.Participant;
...
import com.google.code.bpmn_simulator.bpmn.model.core.common.ElementWithDefaultSequenceFlow;
import com.google.code.bpmn_simulator.bpmn.model.core.common.Error;
import com.google.code.bpmn_simulator.bpmn.model.core.common.Expression;
...
import com.google.code.bpmn_simulator.bpmn.model.core.common.artifacts.Association;
import com.google.code.bpmn_simulator.bpmn.model.core.common.artifacts.Group;
import com.google.code.bpmn_simulator.bpmn.model.core.common.artifacts.TextAnnotation;
import com.google.code.bpmn_simulator.bpmn.model.core.common.events.AbstractEvent;
import com.google.code.bpmn_simulator.bpmn.model.core.common.events.BoundaryEvent;
import com.google.code.bpmn_simulator.bpmn.model.core.common.events.ConditionalEventDefinition;
import com.google.code.bpmn_simulator.bpmn.model.core.common.events.EndEvent;
import com.google.code.bpmn_simulator.bpmn.model.core.common.events.ErrorEventDefinition;
import com.google.code.bpmn_simulator.bpmn.model.core.common.events.IntermediateCatchEvent;
import com.google.code.bpmn_simulator.bpmn.model.core.common.events.IntermediateThrowEvent;
import com.google.code.bpmn_simulator.bpmn.model.core.common.events.LinkEventDefinition;
import com.google.code.bpmn_simulator.bpmn.model.core.common.events.MessageEventDefinition;
import com.google.code.bpmn_simulator.bpmn.model.core.common.events.Signal;
import com.google.code.bpmn_simulator.bpmn.model.core.common.events.SignalEventDefinition;
import com.google.code.bpmn_simulator.bpmn.model.core.common.events.StartEvent;
import com.google.code.bpmn_simulator.bpmn.model.core.common.events.TerminateEventDefinition;
import com.google.code.bpmn_simulator.bpmn.model.core.common.events.TimerEventDefinition;
import com.google.code.bpmn_simulator.bpmn.model.core.common.gateways.AbstractGateway;
import com.google.code.bpmn_simulator.bpmn.model.core.common.gateways.EventBasedGateway;
...
import com.google.code.bpmn_simulator.bpmn.model.core.common.gateways.ParallelGateway;
...
import com.google.code.bpmn_simulator.bpmn.model.process.Lane;
import com.google.code.bpmn_simulator.bpmn.model.process.LaneSet;
import com.google.code.bpmn_simulator.bpmn.model.process.activities.AbstractActivity;
...
import com.google.code.bpmn_simulator.bpmn.model.process.activities.Transaction;
import com.google.code.bpmn_simulator.bpmn.model.process.activities.tasks.BusinessRuleTask;
import com.google.code.bpmn_simulator.bpmn.model.process.activities.tasks.ManualTask;
import com.google.code.bpmn_simulator.bpmn.model.process.activities.tasks.ReceiveTask;
import com.google.code.bpmn_simulator.bpmn.model.process.activities.tasks.ScriptTask;
import com.google.code.bpmn_simulator.bpmn.model.process.activities.tasks.SendTask;
import com.google.code.bpmn_simulator.bpmn.model.process.activities.tasks.ServiceTask;
import com.google.code.bpmn_simulator.bpmn.model.process.activities.tasks.Task;
import com.google.code.bpmn_simulator.bpmn.model.process.activities.tasks.UserTask;
import com.google.code.bpmn_simulator.bpmn.model.process.data.DataAssociation;
import com.google.code.bpmn_simulator.bpmn.model.process.data.DataObject;
import com.google.code.bpmn_simulator.bpmn.model.process.data.DataStore;
...
import com.google.code.bpmn_simulator.framework.element.ElementRefCollection;
import com.google.code.bpmn_simulator.framework.exception.StructureException;
import com.google.code.bpmn_simulator.framework.execution.InstanceAnimator;
